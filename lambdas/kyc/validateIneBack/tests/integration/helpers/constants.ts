...
export const TEST_KYC_RECORD = {
  ...
  userId: TEST_USER_ID,
  step: 'INE_BACK',
  s3Keys: { INE_BACK: 'onboarding/2025/06/27/b3c4d5e6-f7a8-9012-cdef-012345678902/INE_BACK.jpg' },
...
export const READ_KYC_RECORD = {
  ...
  userId: READ_USER_ID,
  step: 'INE_BACK',
  s3Keys: { INE_BACK: 'onboarding/2025/06/27/b3c4d5e6-f7a8-9012-cdef-012345678903/INE_BACK.jpg' },
  fullName: 'JUAN PEREZ GARCIA',
  amount: 10000,
  term: 12,
  expires_at: Math.floor(Date.now() / 1000) + 86400,
