...
export const TEST_KYC_RECORD = {
  ...
  userId: TEST_USER_ID,
  step: 'CONDITIONS',
  s3Keys: { INE_FRONT: 'onboarding/2025/06/27/a2b3c4d5-e6f7-8901-bcde-f12345678901/INE_FRONT.jpg' },
  amount: 10000,
  term: 12,
...
// with TEST_KYC_RECORD, since updateKycWithIneData runs in a parallel worker and mutates step.
export const READ_USER_ID = 'integration-user-validate-ine-read-001'
export const READ_CREDIT_ID = 'a2b3c4d5-e6f7-8901-bcde-f12345678902'

export const READ_KYC_RECORD = {
  creditId: READ_CREDIT_ID,
  userId: READ_USER_ID,
  step: 'CONDITIONS',
  s3Keys: { INE_FRONT: 'onboarding/2025/06/27/a2b3c4d5-e6f7-8901-bcde-f12345678902/INE_FRONT.jpg' },
  amount: 10000,
  term: 12,
  expires_at: Math.floor(Date.now() / 1000) + 86400,
} as const
...
export const TEST_RFC = 'PEGJ970101ABC'
