...
import { addressesMatch } from './utils/addressNormalizer'
...
export const lambdaHandler = async (
  ...
  try {
    ...
    if (kycRecord.step !== KYC_STEPS.ADDRESS) {
    ...
    await updateKycStep(kycRecord.creditId, KYC_STEPS.CURP, KYC_TABLE_NAME)
