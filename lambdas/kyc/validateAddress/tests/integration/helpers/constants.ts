...
export const TEST_KYC_RECORD = {
  ...
  userId: TEST_USER_ID,
  step: 'ADDRESS',
  s3Key: 'onboarding/2025/06/28/c4d5e6f7-a8b9-0123-def0-123456789003/ADDRESS.jpg',
...
export const READ_KYC_RECORD = {
  ...
  userId: READ_USER_ID,
  step: 'ADDRESS',
  s3Key: 'onboarding/2025/06/28/c4d5e6f7-a8b9-0123-def0-123456789004/ADDRESS.jpg',
  domicilio: 'CALLE HIDALGO 123 COL CENTRO MONTERREY NL',
  amount: 10000,
  term: 12,
  expires_at: Math.floor(Date.now() / 1000) + 86400,
