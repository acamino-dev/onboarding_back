...
const mockFetchContractPayments = fetchContractPayments as jest.MockedFunction<
  typeof fetchContractPayments
>
...
const mockRows = [
  { creditId: 'CRED-001', status: 'ACTIVO', balance: 5000, eventTarget: 'ctl00$lnkRegistro' },
]
...
describe('getCreditHistory', () => {
  beforeEach(() => {
    ...
    mockBuildConsultaUrl.mockReturnValue(
      'https://portal.example.com/Migrado/su_conFinanciera.aspx'
    )
